...
다양한 시각화 유형과 레이아웃을 구현했습니다.

### ▶ 호텔 예약 트렌드 분석 예시
![Dashboard Example 1](images/ex1_1pg.PNG)

### ▶ 홈쇼핑 KPI 및 판매 분석
![Dashboard Example 2](images/ex3_1pg.PNG)

### ▶ 방문객 유형·지역 기반 분석
![Dashboard Example 3](images/ex4_1pg.PNG)

### ▶ 지역별 수거함 및 만족도 분석
![Dashboard Example 4](images/ex5_1pg.PNG)
...
- 워터폴 차트(누적 변화 분석) 구성  
- 필터/파라미터(연월, 기준일자, 지표 선택, 지역 선택 등)를 활용한 동적 분석  
- 계산 필드 및 Table Calculation(YoY, 비율, 누계 등)을 통한 지표 재가공  
- 시트 간 액션(필터/하이라이트)을 활용한 상호작용 설계  
- UX를 고려한 레이아웃·타이틀·컬러 시스템 통일  
