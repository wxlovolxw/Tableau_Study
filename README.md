...
## 🧰 What I Practiced
- 여러 차트 유형 활용(Bar, Line, Area, Scatter, Heatmap, Pie 등)
- KPI 카드·지표 테이블·텍스트 히트맵 구현
- 필터/파라미터(연월, 지표 선택, 지역 선택 등)를 통한 동적 분석
- 계산 필드/Table Calculation을 이용한 지표 재가공
- 사용자 가독성을 고려한 레이아웃 구성 및 대시보드 UX 디자인
